...
const AboutInkarp = () => {
  ...
  return (
    <div className="w-full">
      ...
      {/* Hero Section */}
      <section className="relative w-[96%] mx-auto bg-gradient-to-br from-[#fff6f0] to-[#ffe6eb] flex items-center justify-center px-6 py-12 text-center overflow-hidden">
        <div className="absolute w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(244,98,130,0.4)_0%,rgba(255,255,255,0)_70%)] top-[-100px] right-[-100px] z-0"></div>
        <div className="absolute w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(251,186,90,0.3)_0%,rgba(255,255,255,0)_70%)] bottom-[-100px] left-[-100px] z-0"></div>

        <div className="relative z-10 max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-bold text-[#aa1e46] font-sans">
            Redefining Scientific Excellence in India
          </h1>
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-4">
            <Link to="/verticals" className="px-6 py-3 text-white bg-[#aa1e46] hover:bg-[#8d1a3b] rounded-lg font-semibold transition">
              Our Verticals
            </Link>
            <Link to="/about" className="px-6 py-3 border-2 border-[#aa1e46] text-[#aa1e46] hover:bg-[#aa1e46] hover:text-white rounded-lg font-semibold transition">
              Our Legacy
            </Link>
          </div>
          <section className="w-[96%]  flex items-center justify-center px-4 md:px-10 py-10 mx-auto">
