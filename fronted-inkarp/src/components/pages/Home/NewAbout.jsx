...
function NewAbout() {
  return (
    <div className="w-[95%] mx-auto h-auto bg-gray-100 flex flex-col md:flex-row gap-8 p-6 rounded-2xl shadow-md">
      {/* Left Section - Company Info */}
      <div className="w-full md:w-3/5  rounded-xl p-4 flex flex-col items-center justify-center shadow-md">
        <h2 className="text-2xl font-bold text-gray-800 mb-4 text-center">About Inkarp</h2>
        <img
          src="inkarp.png"
          alt="Company"
      ...
      <div className="w-full md:w-2/3 flex flex-col gap-6">
        ...
        <h2 className="text-2xl font-bold text-gray-800 text-center">Group Companies</h2>

        {/* Subsidiaries */}
        <div className="bg-white p-4 rounded-xl shadow-md">
          <h3 className="text-xl font-bold text-gray-800 mb-3 text-center">Our Subsidiaries</h3>
          <div className="flex justify-center gap-4 mb-3 flex-wrap">
            <img src="inkarp old.svg" alt="Sub 1" className="w-28 h-28 object-contain" />
