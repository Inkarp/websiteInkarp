        ...
        />
          ...
          />
                ...
                <div className="relative text-center md:text-left">
                    <h3 className="text-3xl font-bold text-black mb-6 font-[MaxOT]">
                        Blogs
                    </h3>
                    ...
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        {newsEvents.map((item) => (
                            <div
                                key={item.id}
                                className="bg-red-100 rounded-2xl p-6 text-black shadow-md"
                            >
                                <img
                                    src={item.image}
                                    alt={item.title}
                                    className="w-full h-40 object-fit mb-4 bg-white rounded-xl"
                                />
                                ...
                                <a
                                    href="#"
                                    className="inline-flex items-center text-red-500 hover:text-red-300 font-medium transition py-2 px-4 rounded-md bg-white shadow-md"
                                >
                                    Read more
                                    <svg
                                        className="ml-2 w-4 h-4 fill-current text-black"
